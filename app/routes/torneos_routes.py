...
def create():
    ...
    torneos_services.create_torneo(nombre_torneo, recompensa_torneo, estado_torneo, max_competidores, fecha_inicio, fecha_fin, id_juego)
...
def update(id_torneo):
    ...
    torneos_services.update_torneo(id_torneo, nombre_torneo, recompensa_torneo, estado_torneo, max_competidores, fecha_inicio, fecha_fin, id_juego)
