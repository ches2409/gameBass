...
def create():
    ...
    if avatar_file and avatar_file.filename != "":
        ...
        "avatar_url" in request.form
    ):  # Si no hay archivo, usamos la URL (incluso si está vacía para borrar)
        foto_final = avatar_url

    usuarios_services.create_usuario(
        alias_usuario, email_usuario, password_usuario, foto_final, id_jerarquia
    )
