def get_dashboard_data(current_path):
    ...
    alerts_data = [
        ...
        },
        {
            ...
            "subtitle": "Mapeo dinámico de capacidad nerual y autoridad de mando...",
            "url_info": "/jerarquias",
        ...
        },
        {
            ...
            "subtitle": "Especializaciones de combate codificadas. [Gestión de arquetipos y modelos neurales...]",
            "url_info": "/roles",
            "btn_info": "INYECTAR_ROL",
        },
        {
            "icon": "terminal",
            "title": "[MATRIZ_PROTOCOLOS_EJECUCIÓN]",
            "subtitle": "Definición de reglas de acceso al nucleo...",
            "url_info": "/protocolos",
            "btn_info": "INYECTAR_NODO",
        },
        {
            "icon": "terminal",
